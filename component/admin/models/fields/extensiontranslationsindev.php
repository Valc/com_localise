...
/**
 * Form Field ExtensionTranslationsindev class.
 *
 ...
 * @since       1.0
 */
class JFormFieldExtensionTranslationsindev extends JFormFieldGroupedList
{
	/**
	 * The field type.
	 *
	 * @var    string
	 */
	protected $type = 'ExtensionTranslationsindev';
